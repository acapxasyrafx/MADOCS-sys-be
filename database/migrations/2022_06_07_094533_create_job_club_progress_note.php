...
class CreateJobClubProgressNote extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('job_club_progress_note', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('job_club_progress_note');
    }
}
