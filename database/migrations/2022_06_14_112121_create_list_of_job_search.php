...
class CreateListOfJobSearch extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('list_of_job_search', function (Blueprint $table) {
            $table->increments('id');
            $table->bigInteger('added_by');
            $table->integer('patient_id');
            // $table->string('job_listed');
    ...
    {
        Schema::dropIfExists('list_of_job_search');
    }
}
